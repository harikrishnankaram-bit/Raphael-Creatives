...
export function TechStatement() {
  ...
  return (
    <section
      ref={ref}
      className="relative flex min-h-[90vh] items-end overflow-hidden bg-black px-6 py-32 md:px-10"
    >
      <TextReveal
      ...
      <motion.div
        style={{ y }}
        className="absolute bottom-10 right-6 h-56 w-44 overflow-hidden rounded-xl bg-card md:right-10 md:h-72 md:w-56"
      >
        <img
